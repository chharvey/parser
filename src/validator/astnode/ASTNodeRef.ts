...
import type {ASTNodeArg} from './ASTNodeArg';
import {ASTNodeExpr} from './ASTNodeExpr';



export class ASTNodeRef extends ASTNodeExpr {
	constructor (parse_node: PARSENODE.ParseNodeReference, ref: TOKEN.TokenIdentifier);
	constructor (parse_node: PARSENODE.ParseNodeReference, ref: ASTNodeRef, args: readonly ASTNodeArg[]);
	constructor (
		parse_node: PARSENODE.ParseNodeReference,
